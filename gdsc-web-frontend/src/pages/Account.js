                ...
                <div class="info">
                    <div>
                        <form>
                            ...
                            <input type="email" class="input"></input><br />
                            <label class="label">Your Bio</label><br />
                            <textarea class="input bio" type='text-area'></textarea><br />
                            <label class="label">Your area of interest</label><br />
                            <input type="text" class="input"></input><br />
                            <button type="submit" class="inputs">Save Details</button>
                        </form>
                    </div>
                </div>
            </div>
